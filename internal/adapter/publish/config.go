...
type Config struct {
    ...
    ProducerBatchMaxBytes int      `validate:"omitempty,gte=0"`
    ProducerCompression   string   `validate:"omitempty,oneof=none gzip snappy lz4 zstd"`
    MaxRecordBytes        int      `validate:"omitempty,gte=0"`
}
